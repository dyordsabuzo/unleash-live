...
BASE_URL=$(terraform output -raw apigw_invoke_url)

# cognito IdToken
API_TOKEN=$(aws cognito-idp admin-initiate-auth \
...
# api test - greeter
http GET $BASE_URL/greet Authorization:"Bearer $COGNITO_TOKEN"

# api test - dispatcher
http POST $BASE_URL/dispatch Authorization:"Bearer $COGNITO_TOKEN"
